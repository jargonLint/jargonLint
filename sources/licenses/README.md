...
We also reviewed the [Software Package Data Exchange](https://spdx.dev/) (SPDX) which is developed under the Linux Foundation to develop open standards in SBOM (software bill of materials) documents.
